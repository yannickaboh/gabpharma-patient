...
import 'src/detail_screens.dart' show ConversationScreen, OrderDetailScreen;
...
// toujours un `type`, plus un id spécifique au type. Seuls "order" et
// "support_ticket" ont un écran patient réellement branché sur un id réel
// aujourd'hui ; "delivery" ouvre l'app sans navigation ciblée plutôt que le
// suivi de livraison encore en démo (voir CLAUDE.md, écran 17).
